    ...
    <div className='About-main'>
      <div className="About-section-1">
        <div className='About_container'>
          ...
          <p>Our skilled barbers are skilled in a wide range of styles and cuts and only use high-quality materials. We endeavor to make consumers feel at ease and to help them feel their best.</p>
